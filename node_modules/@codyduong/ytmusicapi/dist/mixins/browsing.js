...
const BrowsingMixin = (Base) => {
    return class Browsing extends Base {
        ...
        async search(query, options) {
            ...
            for (const res of resultsNav) {
                if ('musicShelfRenderer' in res) {
                    ...
                    const category = (0, utils_1.nav)(res, [...index_1.MUSIC_SHELF, ...index_1.TITLE_TEXT], null);
        ...
        async getArtist(channelId) {
            ...
            artist['shuffleId'] = (0, utils_1.nav)(header, [
                'playButton',
                'buttonRenderer',
                ...index_1.NAVIGATION_WATCH_PLAYLIST_ID,
            ], null);
            artist['radioId'] = (0, utils_1.nav)(header, [
                'startRadioButton',
                'buttonRenderer',
                ...index_1.NAVIGATION_WATCH_PLAYLIST_ID,
            ], null);
            artist['subscribers'] = (0, utils_1.nav)(subscriptionButton, ['subscriberCountText', 'runs', 0, 'text'], null);
            artist['subscribed'] = subscriptionButton['subscribed'];
            artist['thumbnails'] = (0, utils_1.nav)(header, index_1.THUMBNAILS, null);
            ...
            if ('musicShelfRenderer' in results[0]) {
                ...
                if ('navigationEndpoint' in (0, utils_1.nav)(musicShelf, index_1.TITLE)) {
