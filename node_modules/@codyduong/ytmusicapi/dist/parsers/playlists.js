...
function parsePlaylistItems(results, menuEntries) {
    ...
    for (const result of results) {
        ...
        try {
            ...
            if (data['menu']) {
                for (const item of (0, utils_1.nav)(data, _1.MENU_ITEMS)) {
                    if (item['menuServiceItemRenderer']) {
                        const menuService = (0, utils_1.nav)(item, _1.MENU_SERVICE);
            ...
            if ('playNavigationEndpoint' in (0, utils_1.nav)(data, _1.PLAY_BUTTON)) {
                videoId = (0, utils_1.nav)(data, _1.PLAY_BUTTON)['playNavigationEndpoint']['watchEndpoint']['videoId'];
                if (data['menu']) {
                    like = (0, utils_1.nav)(data, _1.MENU_LIKE_STATUS, null);
                }
            }
            ...
            const isExplicit = !!(0, utils_1.nav)(data, _1.BADGE_LABEL, null);
            const song = {
                videoId: videoId,
                title: title,
                artists: artists,
            ...
            if (menuEntries) {
                for (const menuEntry of menuEntries) {
                    song[menuEntry.slice(undefined, -1)] = (0, utils_1.nav)(data, [
                        ..._1.MENU_ITEMS,
                        ...menuEntry,
                    ]);
                }
