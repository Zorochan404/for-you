...
var Playlist2 = class extends Feed_default {
  ...
  get items() {
    return observe(this.videos.as(PlaylistVideo_default).filter((video) => video.style !== "PLAYLIST_VIDEO_RENDERER_STYLE_RECOMMENDED_VIDEO"));
  }
  get has_continuation() {
...
var { homepage, version, bugs } = { "homepage": "https://github.com/LuanRT/YouTube.js#readme", "version": "9.0.2", "bugs": { "url": "https://github.com/LuanRT/YouTube.js/issues" } };
