export declare type parseSongArtistsReturn = ReturnType<typeof parseSongArtistsRuns> | null;
...
export declare type parseSongRunsReturn = {
    artists: {
        name: string;
        id?: string | null;
    }[];
...
export declare type parseSongAlbumReturn = {
    name: string | null;
    id: string;
} | null;
export declare function parseSongAlbum(data: any, index: number): parseSongAlbumReturn;
export declare type parseSongMenuTokensReturn = {
    add: string[];
    remove: string[];
};
export declare function parseSongMenuTokens(item: any): any;
export declare type parseLikeStatusReturn = 'LIKE' | 'INDIFFERENT';
