...
exports.parseWatchPlaylist = void 0;
const _1 = require(".");
...
function parseWatchTrack(data) {
    ...
    const _ = (0, utils_1.nav)(data, _1.MENU_ITEMS);
    if (_) {
        for (const item of _) {
    ...
    const track = {
        ...
        title: (0, utils_1.nav)(data, _1.TITLE_TEXT),
        length: (0, utils_1.nav)(data, ['lengthText', 'runs', 0, 'text'], null),
        thumbnail: (0, utils_1.nav)(data, _1.THUMBNAIL),
