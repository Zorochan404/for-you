...
const WatchMixin = (Base) => {
    return class WatchMixin extends Base {
        ...
        async getWatchPlaylist(watchPlaylist) {
            ...
            const watchNextRenderer = (0, utils_1.nav)(response, [
                'contents',
            ...
            if (!('unselectable' in watchNextRenderer['tabs'][1]['tabRenderer'])) {
                lyrics_browse_id =
                    watchNextRenderer['tabs'][1]['tabRenderer']['endpoint']['browseEndpoint']['browseId'];
            }
            //Waiting on bugfix for nav nested arrays objects
            const results = (0, utils_1.nav)(watchNextRenderer, [
            ...
            const playlist = results['contents']
                .map((x) => (0, utils_1.nav)(x, ['playlistPanelVideoRenderer', ...parsers_1.NAVIGATION_PLAYLIST_ID], null))
                .filter((x) => !!x)[0];
            ...
            if ('continuations' in results) {
                ...
                tracks = [
                    ...tracks,
                    ...(await (0, utils_1.getContinuations)(results, 'playlistPanelContinuation', limit - tracks.length, request_func, parse_func, isPlaylist ? '' : 'Radio')),
                ];
            }
