...
function parseSongArtistsRuns(runs) {
    ...
    for (let j = 0; j < Math.trunc(runs.length / 2) + 1; j++) {
        artists.push({
            name: runs[j * 2]['text'],
            id: (0, utils_1.nav)(runs[j * 2], _1.NAVIGATION_BROWSE_ID, null),
        });
    }
    return artists;
}
...
function parseSongRuns(runs) {
    ...
    for (const [i, run] of runs.entries()) {
        ...
        if (run['navigationEndpoint']) {
            const item = {
                name: text,
                id: (0, utils_1.nav)(run, _1.NAVIGATION_BROWSE_ID, null),
            };
...
function parseSongMenuTokens(item) {
    ...
    let libraryAddToken = (0, utils_1.nav)(toggleMenu, ['defaultServiceEndpoint', ..._1.FEEDBACK_TOKEN], null);
    let libraryRemoveToken = (0, utils_1.nav)(toggleMenu, ['toggledServiceEndpoint', ..._1.FEEDBACK_TOKEN], null);
