...
class _YTMusic {
    ...
    constructor(options) {
        ...
        const { auth: auth, user: user, proxies: proxies, language: language = 'en', httpsAgent, } = options ?? {};
        __classPrivateFieldSet(this, __YTMusic_auth, auth ?? null, "f");
        ...
        if (!this._headers?.['x-goog-visitor-id']) {
            ...
            this._headers = (0, case_insensitive_object_1.default)({
                ...this._headers,
                ...helpersGetVisitorId,
            });
        }
