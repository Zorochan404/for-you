...
function parseAlbumHeader(response) {
    const header = (0, utils_1.nav)(response, _1.HEADER_DETAIL);
    let album = {
        title: (0, utils_1.nav)(header, _1.TITLE_TEXT),
        type: (0, utils_1.nav)(header, _1.SUBTITLE),
        thumbnails: (0, utils_1.nav)(header, _1.THUMBNAIL_CROPPED),
    };
    ...
    const menu = (0, utils_1.nav)(header, _1.MENU);
    const toplevel = menu['topLevelButtons'];
    album['audioPlaylistId'] = (0, utils_1.nav)(toplevel, [0, 'buttonRenderer', ..._1.NAVIGATION_WATCH_PLAYLIST_ID], null);
    if (!album['audioPlaylistId']) {
        album['audioPlaylistId'] = (0, utils_1.nav)(toplevel, [0, 'buttonRenderer', ..._1.NAVIGATION_PLAYLIST_ID], null);
    }
    const service = (0, utils_1.nav)(toplevel, [1, 'buttonRenderer', 'defaultServiceEndpoint'], null);
    if (service) {
